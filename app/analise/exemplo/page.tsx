...
const planoExemplo = [
  ...
  },
  {
    ...
    items: [
      { tipo: "externo", titulo: "Guia de LinkedIn para devs iniciantes", tempo: "1h", url: "https://codamos.com.br/guia-definitivo-perfil-profissional-linkedin-passo-a-passo/", motivo: "Entender o que recrutadores buscam no perfil" },
  ...
  },
  {
    ...
    items: [
      ...
      { tipo: "externo", titulo: "Perguntas comuns de entrevistas Java Júnior", tempo: "2h", url: "https://dev.to/gabrielsantosba/perguntas-de-entrevistas-para-desenvolvedor-java-junior-7lp", motivo: "Se preparar para as perguntas comportamentais e técnicas" },
    ],
  },
  {
    semana: 8,
    ...
    items: [
      ...
      { tipo: "externo", titulo: "Aplicar para 10 vagas por semana", tempo: "3h", url: "https://www.gupy.io/candidatos", motivo: "Número consistente de aplicações aumenta exponencialmente as chances" },
    ],
  },
];
